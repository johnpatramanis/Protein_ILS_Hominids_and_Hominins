...
### Run with Rguments: Rscript ./Newick_File.txt ../Dataset_Analysis/Workspace/2_DATASETS/EXAMP1_Dataset/CONCATINATED/CONCATINATED_aln_e.phy_phyml_tree.txt ./EXAMP1/Tree_Distances.txt
...
#### Root Trees at PONGO
Tree1=RootTree(Tree1, 'PONG')
Tree2=RootTree(Tree2, 'PONG')
...
##### Clasify Tree
## Tree1 = (((HUM,CHI),GOR),PONG);
## Tree2 = (((HUM,GOR),CHI),PONG);
## Tree3 = (((CHI,GOR),HUM),PONG);
## Tree4 = ((HUM,CHI,GOR),PONG);


Case1 = ape::is.monophyletic(Tree2,c('HUM','CHI'))
Case2 = ape::is.monophyletic(Tree2,c('HUM','GOR'))
Case3 = ape::is.monophyletic(Tree2,c('CHI','GOR'))
