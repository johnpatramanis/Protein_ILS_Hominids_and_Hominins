...
a) ILS_Hominids: For this version of the analysis we utilised a dataset, consisting of _Homo sapiens_, _Pan troglodytes_, _Gorilla gorilla_ and _Pongo abelii_.
b) ILS_Hominids_Only_Enamel: For this version of the analysis we utilised a dataset, consisting of _Homo sapiens_, _Pan troglodytes_, _Gorilla gorilla_ (outgroup).
